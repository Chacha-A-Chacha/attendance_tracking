...
from app.utils.enhanced_email import EnhancedEmailService, Priority, EmailStatus
...
def send_manual_test_email(recipient):
    ...
    try:
        from app.utils.enhanced_email import email_queue, email_statuses, EmailStatus, Priority
